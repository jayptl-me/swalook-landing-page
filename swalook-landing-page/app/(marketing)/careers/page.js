      ...
      <section className={styles.openingsSection}>
        ...
        <AnimatedSection>
          <div className={styles.openingsContainer}>
            ...
            <div className={styles.openingsCards}>
              {openings.map((o) => (
                <article key={o.role} className={styles.openingCard}>
                  <div className={styles.openingCardTop}>
                    <h3>{o.role}</h3>
                    <span className={styles.openingType}>{o.type}</span>
                  </div>
                  <p className={styles.openingLocation}>{o.location}</p>
                  <a href="mailto:hr@swalook.in" className={styles.applyBtn}>Apply Now</a>
                </article>
              ))}
            </div>
