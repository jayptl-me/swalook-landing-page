import BlogProofFigure from '@/components/blog/BlogProofFigure';

export default function SalonMarketingAutomationArticle() {
  return (
    <>
      <p>
      ...
      <BlogProofFigure
        ...
        alt="Swalook automation and reminder workflow"
        eyebrow="Automation proof"
        title="Automation is only useful when it matches real salon follow-up work"
        body="This example ties reminders and campaign workflows back to an actual interface, which makes the article feel grounded instead of speculative."
        caption="Use the proof image to show the operational workflow behind the automation claims."
      />
