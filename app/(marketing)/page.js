...
import { FiBarChart2, FiBell, FiCalendar, FiCheckCircle, FiClock, FiDollarSign, FiGift, FiHeart, FiLayout, FiMail, FiMessageSquare, FiPackage, FiSettings, FiTrendingDown, FiTrendingUp, FiUsers, FiFileText } from 'react-icons/fi';
...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <HomeFAQSection items={faqItems} openFaq={openFaq} onToggle={(i) => setOpenFaq(openFaq === i ? null : i)} />
    </>
  );
}
